...
const onCurrentChange = (num) => {
    ...
    import { addressListService,addressUpdateService,addressDeleteService,userStartStopService} from '@/api/address.js'
    ...
    const addressList = async () => {
        ...
        address.value = result.data.records;
...
<template>
    <el-card class="page-container">
        ...
        <el-form inline>
            ...
            <el-form-item width="80px" label="宿舍：">
            ...
            <el-form-item label="默认状态：">
                <el-select style="width: 160px" placeholder="请选择" v-model="isDefault">
                    <el-option label="默认" value="1"></el-option>
                    <el-option label="普通" value="0"></el-option>
                </el-select>
            </el-form-item>
 
            <el-form-item  style="width: 200px" label="收货人">
                     <el-input v-model="consignee" placeholder="请输入姓名" clearable />
            </el-form-item>

            <el-form-item>
                <el-button type="primary" @click="addressList">搜索</el-button>
                <el-button @click="collegeId = '';dormitoryId = ''; isDefault = '';consignee='';    addressList();">重置</el-button>
            </el-form-item>
        </el-form>
        <!-- 地址列表 -->
        <el-table :data="address" style="width: 100%">
            <el-table-column label="收货人" width="70px" prop="consignee"></el-table-column>
            <el-table-column label="性别" width="60px" prop="sex">
                <template #default="scope">
                    {{scope.row.sex == 1 ? '男':'女'}}
                </template>
            </el-table-column>
            <el-table-column label="手机号" width="120px" prop="phone"></el-table-column>
            <el-table-column label="拼接地址" width="430px" prop="togetherAddress"></el-table-column>
            <el-table-column label="标签"  width="90px" prop="label"></el-table-column>
            <el-table-column label="用户名"  width="90px" prop="userName"></el-table-column>
        ...
        <el-drawer v-model="visibleDrawer"  :title="title" direction="rtl" size="50%">
            ...
            <el-form :model="addressModel" label-width="100px" >
                <el-form-item label="收货人" >
                    <el-input v-model="addressModel.consignee" placeholder="请输入地址名"></el-input>
                </el-form-item>
