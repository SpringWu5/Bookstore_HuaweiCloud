...
const onCurrentChange = (num) => {
    ...
    import { goodsListService,goodsAddService,goodsUpdateService,goodsDeleteService,userStartStopService} from '@/api/goods.js'
        ...
        <el-drawer v-model="visibleDrawer"  :title="title" direction="rtl" size="50%">
            ...
            <el-form :model="goodsModel" label-width="100px" >
                ...
                <el-form-item label="人气值" > 
                    <el-input v-model="goodsModel.popularity" placeholder="请输入人气值"></el-input>
                </el-form-item>
