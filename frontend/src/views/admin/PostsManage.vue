...
const onCurrentChange = (num) => {
    ...
    import { postsListService,postsAddService,postsUpdateService,postsDeleteService,userStartStopService} from '@/api/posts.js'
    ...
    const postsList = async () => {
        ...
        let result = await postsListService(params);
        //渲染视图
...
const showDialog = (row) => {
    visibleDrawer.value = true; title.value = '修改论坛'
    //数据拷贝
    ...
    postsModel.value.status=String(row.status);  
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>论坛管理</span>
                <div class="extra">
                <el-button type="primary" @click="visibleDrawer = true; title = '新增帖子';clearData()">新增帖子</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
        <el-form inline>
            ...
            <el-form-item  style="width: 200px" label="帖子名">
                     <el-input v-model="name" placeholder="请输入帖子名" clearable />
            </el-form-item>

            <el-form-item>
                <el-button type="primary" @click="postsList">搜索</el-button>
                <el-button @click="categoryId = '';sortBy= ''; status = '';name='';postsList()">重置</el-button>
            </el-form-item>
        </el-form>
        <!-- 论坛列表 --> 
        <el-table :data="posts" style="width: 100%">
            <el-table-column label="帖子名"  prop="name"></el-table-column>
            ...
            <el-table-column label="帖子分类" prop="categoryName"></el-table-column>
        ...
        <el-drawer v-model="visibleDrawer"  :title="title" direction="rtl" size="50%">
            ...
            <el-form :model="postsModel" label-width="100px" >
                ...
                <el-form-item label="人气值" > 
                    <el-input v-model="postsModel.popularity" placeholder="请输入人气值"></el-input>
                </el-form-item>
                 <el-form-item label="权限状态：">
                <el-select style="width: 160px" placeholder="请选择" v-model="postsModel.status">
                    <el-option label="启用" value="1"></el-option>
                    <el-option label="禁用" value="0"></el-option>
                </el-select>
            </el-form-item>
