...
const onCurrentChange = (num) => {
    ...
    import { seekMyListService,seekAddService,seekUpdateService,seekDeleteService,userStartStopService} from '@/api/seek.js'
    ...
    const seekList = async () => {
        ...
        let result = await seekMyListService(params);
        //渲染视图
        ...
        <el-table :data="seek" style="width: 100%">
            ...
            <el-table-column label="操作" width="150"> 
                <template #default="{ row }">
                    ...
                    <el-button v-if="row.status == 1" :icon="Loading" circle plain type="warning" @click="statususer(row,2)"></el-button>
