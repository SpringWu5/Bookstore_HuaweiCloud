...
const onCurrentChange = (num) => {
    ...
    //获取商品列表数据
    import { sellOrdersListService,ordersConfirmService,ordersRejectionService,ordersCancelService } from "@/api/orders.js";
    const ordersList = async () => {
        ...
        let result = await sellOrdersListService(params);
        //渲染视图
