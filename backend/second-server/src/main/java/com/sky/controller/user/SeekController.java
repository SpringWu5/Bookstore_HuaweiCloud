 ...
 */
@Api(tags = "求购物品相关接口")
@RestController("userSeekController")
@RequestMapping("/user/seek")
@Slf4j
public class SeekController {
    ...
    public Result<PageResult> queryGoodsPage(SeekPageQueryDTO seekPageQueryDTO){
        ...
        return Result.success(seekService.userpageQuery(seekPageQueryDTO));
    }
     ...
     * @return
     */
    @ApiOperation("我的求购分页查询")
    @GetMapping("/mySeek/page")
    public Result<PageResult> queryMyGoodsPage(SeekPageQueryDTO seekPageQueryDTO){
        log.info("我的求购分页查询，参数为：{}",seekPageQueryDTO);
        return Result.success(seekService.myPageQuery(seekPageQueryDTO));
    }
}
